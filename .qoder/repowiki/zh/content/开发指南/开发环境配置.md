...
- [README.md](file://resources/docker/lightweight/README.md)
...
- [quick-start.md:1-88](file://docs/quick-start.md#L1-L88)
...
- [milvus-stack-2.6.6.compose.yaml:1-99](file://resources/docker/milvus-stack-2.6.6.compose.yaml#L1-L99)
- [pulsar-stack-3.1.3.compose.yaml:1-65](file://resources/docker/pulsar-stack-3.1.3.compose.yaml#L1-L65)
- [README.md:1-38](file://resources/docker/lightweight/README.md#L1-L38)
...
- [AgentAdapterProperties.java:29-34](file://seahorse-agent-spring-boot-starter/src/main/java/com/miracle/ai/seahorse/agent/adapters/spring/config/AgentAdapterProperties.java#L29-L34)
- [SeahorseAgentNativeAdapterAutoConfiguration.java:190-219](file://seahorse-agent-spring-boot-starter/src/main/java/com/miracle/ai/seahorse/agent/adapters/spring/SeahorseAgentNativeAdapterAutoConfiguration.java#L190-L219)
...
- [README.md:33-38](file://resources/docker/lightweight/README.md#L33-L38)

## 故障排除指南
- 前端静态资源 404
  - 症状：浏览器提示 No static resource /api/ragent/...
  - 原因：Vite 代理未生效或后端未启动
...
- [vite.config.js:11-21](file://frontend/vite.config.js#L11-L21)
- [milvus-stack-2.6.6.compose.yaml:52-90](file://resources/docker/milvus-stack-2.6.6.compose.yaml#L52-L90)
- [pulsar-stack-3.1.3.compose.yaml:52-65](file://resources/docker/pulsar-stack-3.1.3.compose.yaml#L52-L65)
- [pom.xml:238-258](file://pom.xml#L238-L258)
