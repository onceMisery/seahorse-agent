...
- 数据库模式与注释：resources/database/schema_pg.sql
- 初始数据：resources/database/init_data_pg.sql
...
图表来源
- [schema_pg.sql:293-416](file://resources/database/schema_pg.sql#L293-L416)
...
图表来源
- [schema_pg.sql:293-337](file://resources/database/schema_pg.sql#L293-L337)
...
章节来源
- [schema_pg.sql:343-372](file://resources/database/schema_pg.sql#L343-L372)
...
章节来源
- [schema_pg.sql:374-416](file://resources/database/schema_pg.sql#L374-L416)
- [KernelIngestionTaskService.java:128-138](file://seahorse-agent-kernel/src/main/java/com/miracle/ai/seahorse/agent/kernel/application/ingestion/KernelIngestionTaskService.java#L128-L138)
...
章节来源
- [schema_pg.sql:356-416](file://resources/database/schema_pg.sql#L356-L416)
...
图表来源
- [schema_pg.sql:343-416](file://resources/database/schema_pg.sql#L343-L416)
- [JdbcRagTraceRepositoryAdapter.java:43-86](file://seahorse-agent-adapter-repository-jdbc/src/main/java/com/miracle/ai/seahorse/agent/adapters/repository/jdbc/JdbcRagTraceRepositoryAdapter.java#L43-L86)
- [JdbcIngestionTaskRepositoryAdapter.java:47-109](file://seahorse-agent-adapter-repository-jdbc/src/main/java/com/miracle/ai/seahorse/agent/adapters/repository/jdbc/JdbcIngestionTaskRepositoryAdapter.java#L47-L109)
- [JdbcPipelineDefinitionRepositoryAdapter.java:106-112](file://seahorse-agent-adapter-repository-jdbc/src/main/java/com/miracle/ai/seahorse/agent/adapters/repository/jdbc/JdbcPipelineDefinitionRepositoryAdapter.java#L106-L112)
...
- t_rag_trace_run
  ...
  - 参考：[schema_pg.sql:293-314](file://resources/database/schema_pg.sql#L293-L314)
- t_rag_trace_node
  ...
  - 参考：[schema_pg.sql:316-337](file://resources/database/schema_pg.sql#L316-L337)
- t_ingestion_pipeline
  - 主键：id；唯一索引：name,deleted；字段：id、name、description、created_by、updated_by、create_time、update_time、deleted。
  - 参考：[schema_pg.sql:343-354](file://resources/database/schema_pg.sql#L343-L354)
- t_ingestion_pipeline_node
  ...
  - 参考：[schema_pg.sql:356-372](file://resources/database/schema_pg.sql#L356-L372)
- t_ingestion_task
  ...
  - 参考：[schema_pg.sql:374-396](file://resources/database/schema_pg.sql#L374-L396)
- t_ingestion_task_node
  ...
  - 参考：[schema_pg.sql:397-416](file://resources/database/schema_pg.sql#L397-L416)
