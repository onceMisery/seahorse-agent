...
- Remaining completion gate: current-branch code and focused tests are not enough to close the whole plan until a fresh backend plus frontend E2E run proves the Chat Workbench path.
