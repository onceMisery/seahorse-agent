...
Remaining roadmap work is narrowed to the actual Docker/Podman/gVisor sandbox adapter, resource/runtime profile configuration, execution history API/product UI hardening, artifact scanner/prompt visibility gate, sandbox-backed agent tools, and deeper A2A/cross-provider Tool Gateway hardening.
...
Remaining roadmap work is narrowed to the actual Docker/Podman/gVisor sandbox adapter, resource/runtime profile configuration, artifact scanner/prompt visibility gate, artifact detail/policy preview/session list product hardening, sandbox-backed agent tools, and deeper A2A/cross-provider Tool Gateway hardening.
