...
This closes the previous editable-policy UX gap for browser egress posture. Remaining sandbox browser hardening is private-network exception editing, long-lived browser profile governance, stronger runtime isolation, and node-pool scheduling/health.
