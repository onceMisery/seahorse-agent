...
Remaining scanning work is external virus scanning, richer binary/PDF deep scanning with a dedicated engine, archive/container introspection, and production policy UX for scanner findings.
