...
Load --> Activate["激活四层记忆"]
Activate --> Optimize["查询优化"]
...
- 准备端口集合
  ...
  - MemoryEnginePort：编排短期/长期/语义三层记忆读取（DefaultMemoryEnginePort 实现）
  - QueryOptimizerPort：查询优化，专有名词保护和术语映射（RuleBasedQueryOptimizerPort 实现）
