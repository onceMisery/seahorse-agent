...
- [SeahorseAgentNativeAdapterAutoConfiguration.java:226-239](file://seahorse-agent-spring-boot-autoconfigure/src/main/java/com/miracle/ai/seahorse/agent/adapters/spring/SeahorseAgentNativeAdapterAutoConfiguration.java#L226-L239)
...
- [application.properties（starter）:1-2](file://seahorse-agent-spring-boot-autoconfigure/src/main/resources/application.properties#L1-L2)
...
- 自动装配（本地/ S3）
  - [SeahorseAgentNativeAdapterAutoConfiguration（S3）:226-232](file://seahorse-agent-spring-boot-autoconfigure/src/main/java/com/miracle/ai/seahorse/agent/adapters/spring/SeahorseAgentNativeAdapterAutoConfiguration.java#L226-L232)
  - [SeahorseAgentNativeAdapterAutoConfiguration（本地）:234-239](file://seahorse-agent-spring-boot-autoconfigure/src/main/java/com/miracle/ai/seahorse/agent/adapters/spring/SeahorseAgentNativeAdapterAutoConfiguration.java#L234-L239)
- 业务集成（知识库文档服务）
