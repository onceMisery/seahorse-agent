...
- [SeahorseTokenServiceAdapter.java](file://seahorse-agent-adapter-web/src/main/java/com/miracle/ai/seahorse/agent/adapters/web/SeahorseTokenServiceAdapter.java)
</cite>
...
M[SeahorseTokenServiceAdapter<br/>令牌服务适配器]
end
A --> E
B --> F
B --> G
...
I[SeahorseTokenServiceAdapter<br/>令牌服务]
end
subgraph "外部系统"
J[数据库]
K[Spring Security]
...
E -.-> P[SeahorseTokenServiceAdapter]
end
A -.-> Q[Spring Security]
A -.-> R[Sa-Token]
A -.-> S[JWT]
