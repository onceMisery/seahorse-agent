...
- [application.properties（Spring Boot 启动器）](file://seahorse-agent-spring-boot-autoconfigure/src/main/resources/application.properties)
</cite>
...
章节来源
- [OpenAiCompatibleModelProperties.java:23-69](file://seahorse-agent-adapter-ai-openai-compatible/src/main/java/com/miracle/ai/seahorse/agent/adapters/ai/openai/OpenAiCompatibleModelProperties.java#L23-L69)
- [AgentAdapterProperties.java:29-57](file://seahorse-agent-spring-boot-autoconfigure/src/main/java/com/miracle/ai/seahorse/agent/adapters/spring/config/AgentAdapterProperties.java#L29-L57)
- [application.properties（Spring Boot 启动器）:1-2](file://seahorse-agent-spring-boot-autoconfigure/src/main/resources/application.properties#L1-L2)
