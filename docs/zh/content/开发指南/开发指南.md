...
章节来源
- [docs/USER_GUIDE.md:70-82](file://docs/USER_GUIDE.md#L70-L82)
...
## 依赖分析
- 版本与依赖管理
  - Spring Boot 3.5.7、Java 21、MyBatis Plus、Milvus、Pulsar、S3、OkHttp、Sa-Token、Redisson 等由根 POM 的 dependencyManagement 统一管理。
- 构建插件
...
章节来源
- [docs/USER_GUIDE.md:51-55](file://docs/USER_GUIDE.md#L51-L55)
...
### 开发环境与 IDE 设置
- JDK 与构建
  - 使用 Java 21，Maven 3.6+，推荐在 IDE 中启用”Import Maven Projects Automatically”。
- Lombok 支持
...
章节来源
- [docs/USER_GUIDE.md:1-88](file://docs/USER_GUIDE.md#L1-L88)
- [frontend/TESTING.md:1-112](file://frontend/TESTING.md#L1-L112)
