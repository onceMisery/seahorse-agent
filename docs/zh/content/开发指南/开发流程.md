...
- [README.md（轻量级部署）](file://resources/docker/lightweight/README.md)
...
- [quick-start.md:15-22](file://docs/quick-start.md#L15-L22)
...
章节来源
- [quick-start.md:83-88](file://docs/quick-start.md#L83-L88)
...
- 性能测试
  ...
  - 参考：[quick-start.md（性能门禁命令）:51-55](file://docs/quick-start.md#L51-L55)

章节来源
- [pom.xml:230-236](file://pom.xml#L230-L236)
- [seahorse-agent-tests/pom.xml:14-35](file://seahorse-agent-tests/pom.xml#L14-L35)
- [quick-start.md:51-55](file://docs/quick-start.md#L51-L55)
...
- 部署策略
  ...
  - 参考：[README.md（轻量级部署）:1-38](file://resources/docker/lightweight/README.md#L1-L38)
...
- [pom.xml:230-236](file://pom.xml#L230-L236)
- [seahorse-agent-tests/pom.xml:14-35](file://seahorse-agent-tests/pom.xml#L14-L35)
- [README.md（轻量级部署）:1-38](file://resources/docker/lightweight/README.md#L1-L38)
...
- 回归测试
  - 使用性能对比脚本与测试模块确保无回归。
  - 参考：[quick-start.md（性能门禁命令）:51-55](file://docs/quick-start.md#L51-L55)，[seahorse-agent-tests/pom.xml:14-35](file://seahorse-agent-tests/pom.xml#L14-L35)
...
### 文档编写与维护
- 技术文档
  - 更新 quick-start 与架构评审文档，同步任务计划与进度。
  - 参考：[quick-start.md（后续开发约束）:83-88](file://docs/quick-start.md#L83-L88)
- API 文档
...
## 附录
- 快速开始与常用验证
  - 参考：[quick-start.md（默认入口与常用验证）:7-36](file://docs/quick-start.md#L7-L36)
- 前端开发与质量工具
...
章节来源
- [quick-start.md:7-36](file://docs/quick-start.md#L7-L36)
- [package.json:6-12](file://frontend/package.json#L6-L12)
- [.eslintrc.cjs:1-27](file://frontend/.eslintrc.cjs#L1-L27)
