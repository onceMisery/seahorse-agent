...
章节来源
- [quick-start.md:83-88](file://docs/USER_GUIDE.md#L83-L88)
...
- 性能测试
  ...
  - 参考：[quick-start.md（性能门禁命令）:51-55](file://docs/USER_GUIDE.md#L51-L55)
...
- 回归测试
  - 使用性能对比脚本与测试模块确保无回归。
  - 参考：[quick-start.md（性能门禁命令）:51-55](file://docs/USER_GUIDE.md#L51-L55)，[seahorse-agent-tests/pom.xml:14-35](file://seahorse-agent-tests/pom.xml#L14-L35)
...
- 技术文档
  ...
  - 参考：[quick-start.md（后续开发约束）:83-88](file://docs/USER_GUIDE.md#L83-L88)
- API 文档
...
## 附录
- 快速开始与常用验证
  - 参考：[quick-start.md（默认入口与常用验证）:7-36](file://docs/USER_GUIDE.md#L7-L36)
- 前端开发与质量工具
...
章节来源
- [quick-start.md:7-36](file://docs/USER_GUIDE.md#L7-L36)
- [package.json:6-12](file://frontend/package.json#L6-L12)
- [.eslintrc.cjs:1-27](file://frontend/.eslintrc.cjs#L1-L27)
