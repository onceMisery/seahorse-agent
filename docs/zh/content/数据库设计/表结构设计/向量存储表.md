...
## 项目结构
围绕向量存储表的关键文件分布如下：
- 数据库模式定义：resources/database/schema_pg.sql
...
- 初始化数据：resources/database/init_data_pg.sql
...
图表来源
- [schema_pg.sql:419-436](file://resources/database/schema_pg.sql#L419-L436)
...
### 向量维度选择与索引类型
- 维度选择
  - 表定义中 embedding 使用 1536 维向量，适配常见通用嵌入模型（如某些通用语义向量）
...
章节来源
- [schema_pg.sql:422-427](file://resources/database/schema_pg.sql#L422-L427)
...
章节来源
- [schema_pg.sql:116-127](file://resources/database/schema_pg.sql#L116-L127)
- [PgVectorProperties.java:32-37](file://seahorse-agent-adapter-vector-pgvector/src/main/java/com/miracle/ai/seahorse/agent/adapters/vector/pgvector/PgVectorProperties.java#L32-L37)
...
章节来源
- [schema_pg.sql:840-849](file://resources/database/schema_pg.sql#L840-L849)
- [schema_pg.sql:815-838](file://resources/database/schema_pg.sql#L815-L838)
