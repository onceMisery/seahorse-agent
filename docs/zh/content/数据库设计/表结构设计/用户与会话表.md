...
graph TB
subgraph "数据库脚本"
A["seahorse_init.sql<br/>PostgreSQL建表与索引"]
...
- [schema_table.sql:1-200](file://resources/database/seahorse_init.sql#L1-L200)
...
- [seahorse_init.sql:1-5](file://resources/database/seahorse_init.sql#L1-L5)
- [schema_table.sql:1-402](file://resources/database/seahorse_init.sql#L1-L402)
...
**章节来源**
- [seahorse_init.sql:43-98](file://resources/database/seahorse_init.sql#L43-L98)
