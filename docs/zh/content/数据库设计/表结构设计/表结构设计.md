...
- seahorse_init.sql：完整建表与注释脚本
- seahorse_init.sql：初始化管理员用户数据
- seahorse_init.sql：统一初始化脚本，体现演进与兼容
- 后端 JDBC 适配器中对部分表（如语义记忆表）的访问逻辑，用于印证表结构与查询模式

```mermaid
graph TB
A["resources/database/seahorse_init.sql<br/>完整建表与注释"] --> B["PostgreSQL 数据库"]
C["resources/database/seahorse_init.sql<br/>初始管理员数据"] --> B
D["resources/database/seahorse_init.sql<br/>统一初始化脚本"] --> B
...
章节来源
- [seahorse_init.sql:32-52](file://resources/database/seahorse_init.sql#L32-L52)
...
章节来源
- [seahorse_init.sql:54-65](file://resources/database/seahorse_init.sql#L54-L65)
...
章节来源
- [seahorse_init.sql:67-81](file://resources/database/seahorse_init.sql#L67-L81)
- [seahorse_init.sql:4-5](file://resources/database/seahorse_init.sql#L4-L5)
...
章节来源
- [seahorse_init.sql:83-98](file://resources/database/seahorse_init.sql#L83-L98)
...
章节来源
- [seahorse_init.sql:100-110](file://resources/database/seahorse_init.sql#L100-L110)
...
- [seahorse_init.sql:4-8](file://resources/database/seahorse_init.sql#L4-L8)
...
章节来源
- [seahorse_init.sql:199-221](file://resources/database/seahorse_init.sql#L199-L221)
...
章节来源
- [seahorse_init.sql:223-242](file://resources/database/seahorse_init.sql#L223-L242)
...
章节来源
- [seahorse_init.sql:248-272](file://resources/database/seahorse_init.sql#L248-L272)
...
章节来源
- [seahorse_init.sql:274-291](file://resources/database/seahorse_init.sql#L274-L291)
...
章节来源
- [seahorse_init.sql:293-314](file://resources/database/seahorse_init.sql#L293-L314)
...
章节来源
- [seahorse_init.sql:316-337](file://resources/database/seahorse_init.sql#L316-L337)
...
章节来源
- [seahorse_init.sql:343-354](file://resources/database/seahorse_init.sql#L343-L354)
...
章节来源
- [seahorse_init.sql:356-372](file://resources/database/seahorse_init.sql#L356-L372)
...
章节来源
- [seahorse_init.sql:374-395](file://resources/database/seahorse_init.sql#L374-L395)
...
章节来源
- [seahorse_init.sql:397-416](file://resources/database/seahorse_init.sql#L397-L416)
...
- [seahorse_init.sql:800-850](file://resources/database/seahorse_init.sql#L800-L850)
...
章节来源
- [seahorse_init.sql:3-4](file://resources/database/seahorse_init.sql#L3-L4)
