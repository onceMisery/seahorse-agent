...
- 已新增 `MetadataExtractionResultInboundPort`、`MetadataExtractionResultManagementRepositoryPort`、`MetadataExtractionResultQuery`、`MetadataExtractionResultRecord` 与 `KernelMetadataExtractionResultService`，支持按租户、知识库、文档、任务和状态分页查询抽取结果。
