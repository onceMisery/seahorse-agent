...
> 当前状态提示：本文保留 Clean Architecture、端口适配器和插件机制的背景说明。当前代码基线、部署事实和演进路线图请优先参考 `docs/architecture/current-code-architecture.md` 与 `docs/roadmap/architecture-roadmap-and-vision.md`。
