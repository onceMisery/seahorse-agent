...
subgraph "基础设施"
MILVUS["Milvus 编排<br/>milvus-stack-2.6.6.compose.yaml"]
PULSAR["Pulsar 编排<br/>pulsar-stack-3.1.3.compose.yaml"]
end
APP --> KCP
APP --> KME
APP --> KRT
...
**章节来源**
- [rag-baseline.json:6-32](file://docs/performance/rag-baseline.json#L6-L32)
- [MicrometerObservationAdapter.java:42-71](file://seahorse-agent-adapter-observation-micrometer/src/main/java/com/miracle/ai/seahorse/agent/adapters/observation/micrometer/MicrometerObservationAdapter.java#L42-L71)
...
- 工具与参考
  ...
  - 内核模式配置：[application.properties:1-2](file://seahorse-agent-spring-boot-starter/src/main/resources/application.properties#L1-L2)
  - 自动装配清单：[SeahorseAgentKernelAutoConfiguration.java:188-431](file://seahorse-agent-spring-boot-starter/src/main/java/com/miracle/ai/seahorse/agent/adapters/spring/SeahorseAgentKernelAutoConfiguration.java#L188-L431)
...
- 工具与参考
  ...
  - Milvus 健康检查：[milvus-stack-2.6.6.compose.yaml:74-79](file://resources/docker/milvus-stack-2.6.6.compose.yaml#L74-L79)
  - Pulsar 初始化与端口：[pulsar-stack-3.1.3.compose.yaml:30-51](file://resources/docker/pulsar-stack-3.1.3.compose.yaml#L30-L51)
...
- 工具与参考
  ...
  - 性能基线：[rag-baseline.json:6-32](file://docs/performance/rag-baseline.json#L6-L32)
...
- 工具与参考
  ...
  - 基线对比：[rag-baseline.json:6-32](file://docs/performance/rag-baseline.json#L6-L32)
...
- 工具与参考
  - Pulsar 主题初始化：[pulsar-stack-3.1.3.compose.yaml:52-64](file://resources/docker/pulsar-stack-3.1.3.compose.yaml#L52-L64)
  - 追踪记录器：[KernelRagTraceRecorder.java:66-110](file://seahorse-agent-kernel/src/main/java/com/miracle/ai/seahorse/agent/kernel/application/trace/KernelRagTraceRecorder.java#L66-L110)
...
**章节来源**
- [pulsar-stack-3.1.3.compose.yaml:52-64](file://resources/docker/pulsar-stack-3.1.3.compose.yaml#L52-L64)
- [KernelRagTraceRecorder.java:66-110](file://seahorse-agent-kernel/src/main/java/com/miracle/ai/seahorse/agent/kernel/application/trace/KernelRagTraceRecorder.java#L66-L110)
- [SeahorseWebExceptionHandler.java:36-52](file://seahorse-agent-adapter-web/src/main/java/com/miracle/ai/seahorse/agent/adapters/web/SeahorseWebExceptionHandler.java#L36-L52)
