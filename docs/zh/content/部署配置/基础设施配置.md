...
- [milvus-stack-2.5.8.compose.yaml（轻量版）](file://resources/docker/lightweight/milvus-stack-2.5.8.compose.yaml)
...
- [SeahorseAgentNativeAdapterAutoConfiguration.java:160-167](file://seahorse-agent-spring-boot-starter/src/main/java/com/miracle/ai/seahorse/agent/adapters/spring/SeahorseAgentNativeAdapterAutoConfiguration.java#L160-L167)
...
### 数据库配置（PostgreSQL）
- 初始化与迁移
  - 使用 schema_pg.sql 创建基础表结构；init_data_pg.sql 插入初始数据；升级脚本按版本顺序执行。
...
```mermaid
flowchart TD
Start(["开始"]) --> Init["执行 schema_pg.sql 初始化"]
Init --> Seed["执行 init_data_pg.sql 导入初始数据"]
Seed --> Upgrade1["执行 upgrade_v1.0_to_v1.1.sql"]
Upgrade1 --> Upgrade2["执行 upgrade_v1.1_to_v1.2.sql"]
Upgrade2 --> Upgrade3["执行 upgrade_v1.2_to_v1.3.sql"]
Upgrade3 --> Done(["完成"])
```
...
章节来源
- [SeahorseAgentNativeAdapterAutoConfiguration.java:386-408](file://seahorse-agent-spring-boot-starter/src/main/java/com/miracle/ai/seahorse/agent/adapters/spring/SeahorseAgentNativeAdapterAutoConfiguration.java#L386-L408)
...
- [milvus-stack-2.6.6.compose.yaml:61-64](file://resources/docker/milvus-stack-2.6.6.compose.yaml#L61-L64)

章节来源
- [milvus-stack-2.6.6.compose.yaml:1-99](file://resources/docker/milvus-stack-2.6.6.compose.yaml#L1-L99)
- [milvus-stack-2.5.8.compose.yaml（轻量版）:1-90](file://resources/docker/lightweight/milvus-stack-2.5.8.compose.yaml#L1-L90)
...
- [application.properties:1-2](file://seahorse-agent-spring-boot-starter/src/main/resources/application.properties#L1-L2)
- [application.yml:1-7](file://seahorse-agent-mcp-server/src/main/resources/application.yml#L1-L7)
- [milvus-stack-2.6.6.compose.yaml:58-64](file://resources/docker/milvus-stack-2.6.6.compose.yaml#L58-L64)
- [pulsar-stack-3.1.3.compose.yaml:39-47](file://resources/docker/pulsar-stack-3.1.3.compose.yaml#L39-L47)
- [PgVectorProperties.java:28-38](file://seahorse-agent-adapter-vector-pgvector/src/main/java/com/miracle/ai/seahorse/agent/adapters/vector/pgvector/PgVectorProperties.java#L28-L38)
