...
- [resources/database/schema_pg.sql](file://resources/database/schema_pg.sql)
...
图表来源
- [docs/quick-start.md:7-9](file://docs/quick-start.md#L7-L9)
...
章节来源
- [docs/quick-start.md:7-36](file://docs/quick-start.md#L7-L36)
...
- 执行schema_pg.sql创建所有表结构。
- 执行init_data_pg.sql插入初始管理员用户数据。
- Docker Compose提供Milvus与Pulsar的快速部署方案。

```mermaid
flowchart TD
DBStart["安装PostgreSQL"] --> EnableExt["启用pgvector扩展"]
EnableExt --> CreateSchema["执行schema_pg.sql创建表结构"]
CreateSchema --> InitData["执行init_data_pg.sql导入初始数据"]
InitData --> Verify["验证数据库连接与表结构"]
Verify --> Done["完成"]
```

图表来源
- [resources/database/schema_pg.sql:1-8](file://resources/database/schema_pg.sql#L1-L8)
- [resources/database/init_data_pg.sql:1-5](file://resources/database/init_data_pg.sql#L1-L5)
- [resources/docker/milvus-stack-2.6.6.compose.yaml:52-79](file://resources/docker/milvus-stack-2.6.6.compose.yaml#L52-L79)
- [resources/docker/pulsar-stack-3.1.3.compose.yaml:30-51](file://resources/docker/pulsar-stack-3.1.3.compose.yaml#L30-L51)

章节来源
- [resources/database/schema_pg.sql:1-850](file://resources/database/schema_pg.sql#L1-L850)
- [resources/database/init_data_pg.sql:1-5](file://resources/database/init_data_pg.sql#L1-L5)
