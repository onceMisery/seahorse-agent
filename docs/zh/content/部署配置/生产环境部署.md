...
章节来源
- [pom.xml:37-60](file://pom.xml#L37-L60)
- [USER_GUIDE.md:1-20](file://docs/USER_GUIDE.md#L1-L20)
...
### 应用启动参数与 JVM 配置
- Java 版本与内存
  - 基于 Maven 属性设定 Java 21；容器内 JVM 堆大小建议占内存上限 60%-80%，预留 GC 与直接内存。
- 垃圾回收与参数
...
- [USER_GUIDE.md:57-82](file://docs/USER_GUIDE.md#L57-L82)
