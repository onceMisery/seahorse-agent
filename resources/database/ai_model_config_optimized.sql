-- AI 模型配置表 - Optimized with BIGINT Primary Key
...
VALUES
    (1, 'ai.base.url', 'https://api.siliconflow.cn/v1', 'STRING', 0, 'AI 服务基础地址', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
    (2, 'ai.api.key', '3JvECMxYoV7DShtYsEhBxA==', 'STRING', 1, 'AI 服务 API 密钥占位值，请通过系统设置界面配置真实密钥', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
    (3, 'ai.chat.model', 'deepseek-ai/DeepSeek-V3.2', 'STRING', 0, '对话模型', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
    (4, 'ai.embedding.model', 'BAAI/bge-m3', 'STRING', 0, '向量化模型', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
    (5, 'ai.rerank.model', 'Qwen/Qwen3-Reranker-8B', 'STRING', 0, '重排序模型', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)
