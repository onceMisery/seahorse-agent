...
/**
 * Web adapter callback factory for Spring SSE based chat streaming.
 */
public interface ChatStreamCallbackFactoryPort {

    StreamCallback create(SseEmitter emitter, String conversationId, String taskId);
