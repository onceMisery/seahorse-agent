...
class SeahorseAgentRunControllerConstructionTests {

    @Test
    void shouldExposeSingleSpringConstructorForPluggableProviders() {
        Constructor<?>[] constructors = SeahorseAgentRunController.class.getConstructors();
