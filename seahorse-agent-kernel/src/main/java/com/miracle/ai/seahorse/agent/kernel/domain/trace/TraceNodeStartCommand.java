 ...
 * Trace node 启动命令。
 */
public record TraceNodeStartCommand(String nodeName,
                                    String nodeType,
                                    String className,
                                    String methodName,
                                    String parentNodeId,
    ...
    public static TraceNodeStartCommand pipelineStage(String nodeName, String nodeType, String methodName) {
        return new TraceNodeStartCommand(nodeName, nodeType,
                "com.miracle.ai.seahorse.agent.kernel.application.chat.KernelChatPipeline",
                methodName, null, 0);
    }
