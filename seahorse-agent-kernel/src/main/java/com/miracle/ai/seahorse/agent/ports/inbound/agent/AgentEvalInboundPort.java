...
public interface AgentEvalInboundPort {

    AgentEvalSummary saveSummary(AgentEvalSummarySaveCommand command);

    Optional<AgentEvalSummary> latestSummary(String tenantId, String agentId, String versionId, AgentEvalType evalType);

    AgentEvalSummaryPage history(AgentEvalSummaryHistoryQuery query);
}
