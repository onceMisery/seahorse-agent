...
public interface QuotaManagementInboundPort {

    QuotaPolicy upsertPolicy(QuotaPolicyUpsertCommand command);

    void disablePolicy(String policyId);

    QuotaDecisionResult evaluate(QuotaDecisionCommand command);
}
