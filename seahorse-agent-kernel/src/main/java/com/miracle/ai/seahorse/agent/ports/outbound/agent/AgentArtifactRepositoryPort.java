...
public interface AgentArtifactRepositoryPort {

    AgentArtifact save(AgentArtifact artifact);

    Optional<AgentArtifact> findById(String artifactId);

    List<AgentArtifact> listByRunId(String runId);

    static AgentArtifactRepositoryPort empty() {
        return new AgentArtifactRepositoryPort() {
            @Override
