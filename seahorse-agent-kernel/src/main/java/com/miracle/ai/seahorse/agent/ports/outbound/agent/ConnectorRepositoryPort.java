...
public interface ConnectorRepositoryPort {
    ...
    Optional<Connector> findConnectorById(String connectorId);

    Optional<ConnectorVersion> findVersionByConnectorIdAndSpecHash(String connectorId, String specHash);

    ConnectorVersion saveVersion(ConnectorVersion version);

    ConnectorOperation saveOperation(ConnectorOperation operation);
