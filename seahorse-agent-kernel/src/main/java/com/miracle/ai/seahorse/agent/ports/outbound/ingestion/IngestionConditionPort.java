 ...
 * 入库节点条件判断端口。
 */
public interface IngestionConditionPort {

    boolean shouldExecute(IngestionContext context, NodeConfig config);

    static IngestionConditionPort alwaysExecute() {
        return (context, config) -> true;
    }
}
