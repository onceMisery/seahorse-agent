 ...
 * 入库节点执行日志端口。
 */
public interface IngestionNodeLogPort {

    void record(IngestionContext context, NodeConfig config, NodeResult result, long durationMs);

    static IngestionNodeLogPort noop() {
        return (context, config, result, durationMs) -> {
        };
    }
}
