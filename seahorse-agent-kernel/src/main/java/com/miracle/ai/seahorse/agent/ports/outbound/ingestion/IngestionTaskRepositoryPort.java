 ...
 * 入库任务仓储端口。
 */
public interface IngestionTaskRepositoryPort {

    String createRunningTask(IngestionTaskCreateValues values);

    void updateTask(String taskId, IngestionTaskUpdateValues values);
