...
public interface MemoryAliasPort {
    ...
    Optional<MemoryAliasResolution> resolveAlias(String userId, String tenantId, String aliasText);

    void upsertAlias(MemoryAliasCommand command);

    default List<MemoryAliasCandidate> findMergeCandidates(String userId, String tenantId, int limit) {
        return List.of();
    }
