...
/**
 * Lifecycle governance port for layered memory records.
 */
public interface MemoryLifecyclePort {

    int markObsoleteByProfileSlot(String userId,
                                  String tenantId,
                                  String profileSlot,
                                  String activeGenerationId,
                                  String reason);

    void recordRead(String layer, String memoryId, Instant referencedAt);

    static MemoryLifecyclePort noop() {
