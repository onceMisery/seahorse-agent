...
public record MemoryRefinementResult(
    ...
    public static MemoryRefinementResult empty(String reason) {
        return new MemoryRefinementResult(false, reason, List.of(), Map.of());
    }

    public static MemoryRefinementResult refined(String reason,
                                                 List<RefinedMemoryOperation> operations,
                                                 Map<String, Object> metadata) {
        return new MemoryRefinementResult(true, reason, operations, metadata);
    }
}
