...
public record MemoryReviewDecision(
    ...
    public MemoryReviewDecision {
        candidateId = Objects.requireNonNullElse(candidateId, "").trim();
        reviewStatus = Objects.requireNonNullElse(reviewStatus, MemoryReviewStatus.PENDING);
        reviewerId = Objects.requireNonNullElse(reviewerId, "").trim();
        reviewComment = Objects.requireNonNullElse(reviewComment, "").trim();
        ...
        reviewedMemoryId = Objects.requireNonNullElse(reviewedMemoryId, "").trim();
        reviewedLayer = Objects.requireNonNullElse(reviewedLayer, "").trim();
    }
}
