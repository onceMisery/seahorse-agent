...
public interface TraceTelemetryPort {
    ...
    void startNode(String traceId, String nodeId, TraceNodeStartCommand command, Instant startTime);

    void finishNode(String traceId, String nodeId, String errorMessage, Instant endTime);
