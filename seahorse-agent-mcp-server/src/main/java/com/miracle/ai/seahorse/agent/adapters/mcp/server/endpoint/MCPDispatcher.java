...
import com.miracle.ai.seahorse.agent.adapters.mcp.server.core.*;
import com.miracle.ai.seahorse.agent.adapters.mcp.server.protocol.*;
...
public class MCPDispatcher {
    ...
    private JsonRpcResponse handleInitialize(Object id) {
        ...
        serverInfo.put("name", "seahorse-agent-mcp-server");
