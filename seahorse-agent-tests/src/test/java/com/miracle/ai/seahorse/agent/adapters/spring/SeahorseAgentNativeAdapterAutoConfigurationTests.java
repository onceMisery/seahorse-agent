    ...
    void shouldRegisterJdbcKnowledgeRepositoryWhenDataSourceExists() {
        ...
        contextRunner.withBean(DriverManagerDataSource.class, () -> dataSource)
                ...
                .run(context -> {
                    ...
                    assertThat(context).hasSingleBean(MetadataReviewQueuePort.class);
                    assertThat(context).hasSingleBean(MetadataQuarantinePort.class);
                    ...
                    assertThat(context).hasSingleBean(MetadataExtractionResultRepositoryPort.class);
